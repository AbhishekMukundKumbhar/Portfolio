...
import './SideNav.css';
import { FaGraduationCap, FaTrophy, FaHistory, FaCertificate } from 'react-icons/fa';
        ...
        <>
            ...
            <div className='side-nav'>
                <ul className='side-nav-menu'>
                    <a className='menu-item' active href='#education' ><FaGraduationCap className='sidemenu-item-icon' size={35}/><span className='menu-item-name'>Education</span></a>
                    <a className='menu-item' href= '#achievements' ><FaTrophy size={35} className='sidemenu-item-icon' /><span className='menu-item-name'>Achievements</span></a>
                    ...
                    <a className='menu-item' href='#certification' ><FaCertificate size={35} className='sidemenu-item-icon' /><span className='menu-item-name'>Certification</span></a>
